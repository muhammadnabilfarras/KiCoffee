<?php
   include "db.php";
    ...
    $row_produk = array_column($row, 'jenisProduk');
    $filters_produk = array_unique($row_produk);
?>
...
<body>
    ...
    <section class="col-product">
        <table>
            <?php
                if(!empty($row))
                foreach($filters_produk as $rows){
                    ?>
                    <thead>
                        <tr>
                            <th>#</th>
                    ...
                    foreach($row as $row_data){
                        if($row_data['jenisProduk'] == $rows){
                            ?>
                            <form action="order.php" method="post">
                                <tr>
                                    <td>
                                        <input type="checkbox" name="pesanan[]" value="<?php echo $row_data['namaProduk']; ?>">
                                    </td>
                                    <td>
                                        <img src="./assets/img/product/<?= $row_data['gambar']; ?>">
                                    </td>
                                    <td><?php echo $row_data['namaProduk'];?></td>
                                    <td><?php echo $row_data['hargaProduk'];?></td>
                                </tr>
                            <?php
                        }
                    }
